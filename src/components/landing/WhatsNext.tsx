  ...
  return (
    <section className="relative isolate overflow-hidden px-5 py-24 sm:px-8 sm:py-28">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <h2 className="mx-auto mt-4 max-w-5xl text-center font-display text-6xl font-bold uppercase leading-[0.95] text-white sm:text-8xl">
          Launch your first
          <br />
          <span className="text-white">Financial Scoring offer.</span>
        </h2>
