    ...
    <section id="top" className="relative isolate overflow-hidden">
      ...
      <div className="mx-auto flex min-h-[100svh] max-w-6xl flex-col justify-center px-5 pb-16 pt-28 sm:px-8">
        <div className="flex flex-col items-center gap-7 text-center">
          ...
          <h1 className="w-full font-display text-8xl font-bold uppercase leading-[0.85] sm:text-9xl lg:text-[10rem]">
            <span className="block">Leads are</span>
            <span className="block text-[1.45em] text-[#ff3b30]">dead.</span>
          </h1>
