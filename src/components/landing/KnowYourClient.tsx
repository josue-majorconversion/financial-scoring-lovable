        ...
        <div className="flex flex-col items-center gap-8 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <h2 className="w-full font-display text-[clamp(1.6rem,8.4vw,2.75rem)] font-black uppercase leading-[1] tracking-tight sm:text-5xl lg:text-6xl">
              <span className="block w-full">Could you close bigger</span>
              <span className="block w-full">deals if you</span>
              <span className="block w-full text-gradient-mint">saw the lead's finances?</span>
            </h2>
          </div>
